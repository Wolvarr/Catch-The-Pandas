...
public abstract class Item extends OnTileObject {
    ...
    public void eachTurn() {
    	System.out.println(toString() + "Called function item.eachTurn()");
    }

    
    public void interact(Arcade obj){ System.out.println(toString() + "Called function item.interact()");}

    @Override
    public void interact(CandyVending obj) {
        System.out.println(toString() + "Called function item.interact(CandyVending)");
    }

    @Override
    public void interact(Armchair obj) {
        System.out.println(toString() + "Called function item.interact(Armchair)");
